...
PROFILE_RULES: tuple[ProfileRule, ...] = (
    ...
    ProfileRule(
        ...
        repair_playbook=(
            ...
            "For --remove-nodes failures, verify the removal selector mutates the DOM before the output selector and does not synthesize empty html/head/body wrappers.",
            "For invalid selector failures, copy observed Rust panic text including leading blank line, thread line, source location, selector text, backtrace note, and exit code 101.",
    ...
    ProfileRule(
        ...
        implementation_playbook=(
            ...
            "Implement Go flag semantics manually: -help prints usage to stderr with exit 0; unknown flags print 'flag provided but not defined' plus usage; usage starts with 'Usage of /workspace/executable:'.",
        ...
        repair_playbook=(
            "For table stdout failures, diff header centering, per-column width, border dashes, cell padding, empty Version/Update rendering, and markdown-vs-default style.",
            ...
            "For log stderr failures, copy observed date/time prefix and Go encoding/json wording; do not call time.now() or leak Python parser messages.",
        ),
        anti_patterns=(
